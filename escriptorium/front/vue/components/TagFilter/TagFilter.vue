    ...
    methods: {
        ...
        renderFilteredTagNotice(h) {
            ...
            if (filteredTags.length === 0) {
                return h(
                    "div",
                    this.$t("filter.noMatch", {
                        hidden: this.tags.length,
                        selected: hiddenSelectedTagCount,
                    }),
                );
                ...
                return h(
                    "div",
                    this.$t("filter.hidden", {
                        hidden: hiddenTagCount,
                        selected: hiddenSelectedTagCount,
                    }),
                );
            }
        ...
        return h(
            ...
            [
                ...
                h(
                    "h4",
                    [
                        h("span", this.$t("filter.tags")),
                        h("div", [
                            h(Button, {
                                props: {
                                    label: this.$t("images.selectAll"),
                                    color: "link-primary",
                                    size: "small",
                            ...
                            h(Button, {
                                props: {
                                    label: this.$t("images.unselectAll"),
                                    color: "link-primary",
                                    size: "small",
                ...
                h(
                    ...
                    {
                        props: {
                            label: this.$t("filter.findTag"),
                            labelVisible: false,
                            onInput: this.filterByString,
                            placeholder: this.$t("filter.findTag"),
