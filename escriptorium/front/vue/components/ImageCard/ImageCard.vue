            ...
            <div class="image-status">
                ...
                >
                    ...
                    <template #popper>
                        <div>
                            <SegmentIcon />
                            <span>{{ $t("editor.segmentation") }}</span>
                        </div>
                ...
                >
                    ...
                    <template #popper>
                        <div>
                            <TranscribeIcon />
                            <span>{{ $t("editor.transcription") }}</span>
                        </div>
                        <div class="task-metadata">
                            <span
