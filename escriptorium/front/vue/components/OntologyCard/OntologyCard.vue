    ...
    <div :class="classes">
        <div class="escr-card-header">
            ...
            <div class="escr-card-actions">
                ...
                >
                    {{ $t("projectOntology.viewOverview") }}
                </a>
    ...
    computed: {
        ...
        categories() {
            return [
                ...
                { label: this.$t("projectOntology.text"), value: "text" },
                { label: this.$t("images.title"), value: "image" },
            ].map((category) => ({
                ...category,
        ...
        tableHeaders() {
            return [
                { label: this.$t("ontology.type"), value: "name", sortable: true },
                { label: this.$t("ontology.countInDocument"), value: "frequency", sortable: true },
            ];
        },
    },
    methods: {
