<template>
    <EscrModal class="escr-edit-document">
        <template #modal-header>
            <h2>{{ newDocument ? $t("editDoc.createTitle") : $t("editDoc.editTitle") }}</h2>
            <EscrButton
                color="text"
                :on-click="onCancel"
                size="small"
        ...
        <template #modal-content>
            ...
            />
            <DropdownField
                :label="$t('editDoc.readDirection')"
                :disabled="disabled"
                :help-text="$t('editDoc.readDirectionHelp')"
                :on-change="(e) => handleTextFieldInput('readDirection', e.target.value)"
                :options="readDirectionOptions"
                required
            />
            <DropdownField
                :label="$t('editDoc.linePosition')"
                :help-text="$t('editDoc.linePositionHelp')"
                :disabled="disabled"
            ...
            <DropdownField
                ...
                :help-text="$t('editDoc.transcriptionFontHelp')"
                :disabled="disabled"
        ...
        <template #modal-actions>
            ...
            <EscrButton
                color="primary"
                :label="newDocument ? $t('common.create') : $t('common.save')"
                :on-click="onSave"
    ...
    computed: {
        ...
        readDirectionOptions() {
            return [
                {
                    value: "ltr",
                    label: this.$t("editDoc.ltr"),
                    selected: this.readDirection === "ltr",
                },
                {
                    value: "rtl",
                    label: this.$t("editDoc.rtl"),
