<template>
    <EscrModal class="escr-transcription-management">
        <template #modal-header>
            <h2>{{ $t("transcriptionsModal.title") }}</h2>
            <EscrButton
                color="text"
                :on-click="onCancel"
                size="small"
            ...
            >
                <template #actions="{ item }">
                    ...
                    <EscrButton
                        ...
                        :disabled="disabled"
                        :aria-label="$t('transcriptionsModal.deleteAria')"
                    >
                        <template #button-icon>
                            <TrashIcon />
                        </template>
...
export default {
    ...
    computed: {
        ...
        headers() {
            return [
                { label: this.$t("common.name"), value: "name", sortable: true, editable: true },
                {
                    label: this.$t("transcriptionsModal.dateCreated"),
                    value: "created_at",
                    sortable: true,
                ...
                { label: this.$t("transcriptionsModal.comments"), value: "comments", sortable: false, editable: true },
            ];
        },
