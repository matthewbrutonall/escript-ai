<template>
    ...
    >
        <template #modal-header>
            <h2>{{ $t("exportModal.title", { scope }) }}</h2>
            <EscrButton
                color="text"
                :on-click="onCancel"
                size="small"
        ...
        <template #modal-content>
            <DropdownField
                :label="$t('exportModal.transcription')"
            ...
            />
            <DropdownField
                :label="$t('exportModal.fileFormat')"
                :disabled="disabled"
            ...
            <div class="escr-form-field escr-include-images-field escr-checkbox-field">
                <label>
                    ...
                    >
                    {{ $t("exportModal.includeImages") }}
                </label>
                <span class="escr-help-text">
                    {{ $t("exportModal.includeImagesHelp") }}
                </span>
            </div>
            ...
            <div class="escr-form-field escr-include-characters-field escr-checkbox-field">
                <label>
                    ...
                    >
                    {{ $t("exportModal.includeCharacters") }}
                </label>
                <span class="escr-help-text">
                    {{ $t("exportModal.includeCharactersHelp") }}
                </span>
            </div>
            ...
            <MultiSelectField
                ...
                :help-text="$t('exportModal.regionHelp')"
                :label="$t('exportModal.regionTypes')"
                :placeholder="$t('exportModal.regionPlaceholder')"
            />
        </template>
