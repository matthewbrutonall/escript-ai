    ...
    <div>
        ...
        >
            <thead>
                <tr>
                    <th class="name-column">
                        <div><span>{{ $t("ontologyModal.name") }}</span></div>
                    </th>
                    <th>
                        <div><span>{{ $t("ontologyModal.buttonText") }}</span></div>
                    </th>
                    <th>
                        <div><span>{{ $t("ontologyModal.components") }}</span></div>
                    </th>
                    <th>
                        <div><span>{{ $t("ontology.type") }}</span></div>
                    </th>
                    <th>
                        <div><span>{{ $t("ontologyModal.markerType") }}</span></div>
                    </th>
                    <th class="color-column">
                        <div><span>{{ $t("ontologyModal.color") }}</span></div>
                    </th>
                    <th class="comments-column">
                        <div><span>{{ $t("ontologyModal.comments") }}</span></div>
                    </th>
            ...
            <tbody>
                ...
                >
                        ...
                        >
                            ...
                            <template #popper>
                                <div class="escr-component-selector">
                                    ...
                                    >
                                        <span>{{ $t("ontologyModal.noComponents") }}</span>
                                        <small>{{ $t("ontologyModal.clickAddNew") }}</small>
                                    </div>
                                </div>
                                <div>
                                    <EscrButton
                    ...
                    <td>
                        <DropdownField
                            :label="$t('ontologyModal.markerType')"
                            :disabled="disabled"
        ...
        >
            ...
            <template #modal-content>
                <TextField
                    :label="$t('ontologyModal.name')"
                    :placeholder="$t('ontologyModal.name')"
                    :disabled="disabled"
                ...
                />
                <TextField
                    :help-text="$t('ontologyModal.allowedHelp')"
                    :label="$t('ontologyModal.allowedValues')"
                    :placeholder="$t('ontologyModal.allowedValues')"
                    :disabled="disabled"
                    :on-input="(e) => handleGenericInput({
            ...
            <template #modal-actions>
                ...
                <EscrButton
                    color="primary"
                    :label="editComponentMode === 'add' ? $t('ontologyModal.add') : $t('common.save')"
                    :disabled="disabled"
        ...
        <ConfirmModal
            ...
            :body-text="$t('confirm.deleteNamed', { name: componentToDelete.name })"
            :confirm-verb="$t('common.delete')"
            :title="$t('ontologyModal.deleteComponent')"
            :cannot-undo="true"
            :disabled="disabled"
    ...
    methods: {
        ...
        getMarkerTypeOptions(item) {
            if (this.tab === "text") {
                return [
                    {
                        label: this.$t("ontologyModal.bgColor"),
                        value: "Background Color",
                        selected: item.marker_type === "Background Color",
                    },
                    {
                        label: this.$t("ontologyModal.textColor"),
                        value: "Text Color",
                        selected: item.marker_type === "Text Color",
                    },
                    { label: this.$t("ontologyModal.bold"), value: "Bold", selected: item.marker_type === "Bold" },
                    { label: this.$t("ontologyModal.italic"), value: "Italic", selected: item.marker_type === "Italic" },
                ];
            } else if (this.tab === "image") {
                return [
                    {
                        label: this.$t("ontologyModal.rectangle"),
                        value: "Rectangle",
                        selected: item.marker_type === "Rectangle"
                    },
                    {
                        label: this.$t("ontologyModal.polygon"), value: "Polygon", selected: item.marker_type === "Polygon"
                    },
                ];
            }
            return [];
