    ...
    <EscrModal class="escr-edit-ontology">
        ...
        <template #modal-content="{ scroll }">
            ...
            <h3 v-if="!['image', 'text'].includes(tab)">
                {{ $t("ontologyModal.defaultTypes", { type: tabLabel }) }}
            </h3>
            <table
                    ...
                    >
                        ...
                        >
                            <input
                                ...
                                :aria-label="$t('ontologyModal.selectColor')"
                                :value="item.color"
                                :disabled="disabled"
            ...
            <h3 :class="{'anno-header': ['image', 'text'].includes(tab) }">
                <span v-if="!['image', 'text'].includes(tab)">{{ $t("ontologyModal.customTypes", { type: tabLabel }) }}</span>
...
export default {
    ...
    computed: {
        ...
        tabOptions() {
            return [
                {
                    label: this.$t("ontology.regionTypes"),
                    value: "regions",
                    selected: this.tab === "regions",
                },
                {
                    label: this.$t("ontology.lineTypes"),
                    value: "lines",
                    selected: this.tab === "lines",
                },
                {
                    label: this.$t("ontologyModal.partTypes"),
                    value: "parts",
                    selected: this.tab === "parts",
                },
                {
                    label: this.$t("ontology.textAnnotations"),
                    value: "text",
                    selected: this.tab === "text",
                },
                {
                    label: this.$t("ontology.imageAnnotations"),
                    value: "image",
        ...
        tabLabel() {
            switch (this.tab) {
                case "regions":
                    return this.$t("ontologyModal.region");
                case "lines":
                    return this.$t("ontologyModal.line");
                case "parts":
                    return this.$t("ontologyModal.part");
                case "text":
                    return this.$t("ontology.textAnnotations");
                case "image":
                    return this.$t("ontology.imageAnnotations");
                default:
                    return "";
            }
        },
