<template>
    <div class="escr-model-training-form escr-card escr-card-padding">
        ...
        <EscrTextField
            ...
            :label="$t('train.modelName')"
            :placeholder="$t('train.namePlaceholder')"
        ...
        >
            ...
            >
            <span>{{ $t("train.overwrite") }}</span>
        </label>
        <span
            id="overwrite-help"
            class="sr-only"
        >
            {{ $t("train.overwriteHelp") }}
        </span>
        <EscrButton
...
export default {
    ...
    computed: {
        ...
        modelTypeOptions() {
            return [
                {
                    label: this.$t("train.recognition"),
                    value: "recognizer",
                    selected: this.modelType === "recognizer",
                },
                {
                    label: this.$t("train.segmentation"),
                    value: "segmenter",
