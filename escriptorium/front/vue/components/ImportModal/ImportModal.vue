    ...
    >
        ...
        <template #modal-actions>
            ...
            <EscrButton
                ...
                :label="(importMode !== 'images' || imagesLoading) ? $t('common.cancel') : $t('common.close')"
