    ...
    <div class="escr-image-grid-container">
        <div class="escr-image-grid">
            <div class="escr-grid-toolbar">
                <div class="escr-select-toggles">
                    ...
                    >
                        ...
                        />
                        <template #popper>
                            {{ $t("browser.selectVisibleHint") }}
                        </template>
                    </VDropdown>
                    <EscrButton
                        :label="$t('browser.selectNone')"
                        color="outline-primary"
                        size="small"
                ...
                >
                    <label>{{ $t("browser.defaultLayer") }}</label>
                    <EscrDropdown
            ...
            <EscrLoader
                ...
                :loading="isFetching"
                :no-data-message="$t('browser.emptyImages')"
            />
            <ul v-else>
                <ImageSelectCard
                    v-for="page in pages"
