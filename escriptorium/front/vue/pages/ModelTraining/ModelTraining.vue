                ...
                <div class="escr-training-collections">
                        ...
                        <div class="escr-tab-content">
                            ...
                            >
                                ...
                                <div
                                    ...
                                    role="status"
                                >
                                    <span class="sr-only">{{ $t("training.loadingBrowser") }}</span>
                                </div>
                            </div>
                            ...
                            >
                                ...
                                <div
                                    ...
                                    role="status"
                                >
                                    <span class="sr-only">{{ $t("training.loadingCollection") }}</span>
                                </div>
                                ...
                                >
                                    <p>{{ $t("training.noParts") }}</p>
                                    <p>{{ $t("training.noPartsHint") }}</p>
                                    <EscrButton
                    ...
                    <aside class="escr-training-sidebar">
                        <section class="escr-collection-management">
                            <h2>{{ $t("training.manageCollection") }}</h2>
...
export default {
    ...
    computed: {
        ...
        trainingDataTabs() {
            return [
                { label: this.$t("training.browse"), value: "browse" },
                {
                    label: this.$t("training.selected"),
                    value: "selected",
