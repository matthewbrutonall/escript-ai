<template>
    <div class="escr-downloads">
        ...
        >
            <thead>
                <tr>
                    <th>{{ $t("downloads.label") }}</th>
                    <th>{{ $t("downloads.type") }}</th>
                    <th class="text-right">
                        {{ $t("downloads.size") }}
                    </th>
                    <th>{{ $t("downloads.created") }}</th>
                    <th>{{ $t("downloads.expires") }}</th>
                    <th class="text-right">
                        {{ $t("downloads.nDownloads") }}
                    </th>
                    <th />
                </tr>
            </thead>
            <tbody>
                ...
                >
                    ...
                    <td>
                        <small>
                            <span v-if="!item.expires_at">{{ $t("downloads.never") }}</span>
                            <span
                                v-else
...
export default {
    ...
    methods: {
        ...
        async onDelete(item) {
            if (!confirm(this.$t("downloads.deleteConfirm", { label: item.label }))) {
                return;
            }
            try {
