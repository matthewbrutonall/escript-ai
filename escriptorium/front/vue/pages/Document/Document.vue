            ...
            <div class="escr-grid-container">
                <div class="escr-doc-left-grid">
                    ...
                    <div class="escr-card escr-card-padding escr-document-details">
                        ...
                        <span class="escr-document-metadata">
                            {{ $t("document.mainScript", { script: mainScript }) }}
                        </span>
                    </div>
                    ...
                    <div class="escr-card escr-card-padding escr-document-tags">
                        ...
                        <EscrLoader
                            v-else
                            :loading="loading && loading.document"
                            :no-data-message="$t('document.noTags')"
                        />
                    </div>
                    ...
                    <div class="escr-card escr-card-table escr-document-tasks">
                        ...
                        <EscrLoader
                            ...
                            :no-data-message="$t('document.noTasks')"
                        />
                    </div>
                    ...
                    <div class="escr-card escr-card-table escr-document-images">
                        ...
                        <EscrLoader
                            ...
                            :no-data-message="$t('document.noImages')"
                        />
                    </div>
                </div>
                <div class="escr-doc-right-grid">
                    ...
                    <div class="escr-card escr-card-padding chars-stats">
                        <div class="escr-card-header">
                            <h2>{{ $t("document.totalCharacters") }}</h2>
                        </div>
                        <EscrLoader
                            v-if="!charCount ||
                                (transcriptionLoading && transcriptionLoading.characterCount)
                    ...
                    <div class="escr-card escr-card-padding transcription-status">
                        <h2>{{ $t("document.transcriptionStatus") }}</h2>
                        <dl>
                            <dt>{{ $t("document.confidence") }}</dt>
                ...
                <ConfirmModal
                    ...
                    :body-text="$t('confirm.deleteDocumentBody')"
                ...
                <ConfirmModal
                    ...
                    :body-text="$t('confirm.cancelTaskBody')"
                    :title="$t('confirm.cancelTaskTitle')"
                    :confirm-verb="$t('common.yes')"
                    :cancel-verb="$t('common.no')"
                    :cannot-undo="false"
                    :disabled="loading && loading.tasks"
...
export default {
    ...
    computed: {
         ...
         */
        breadcrumbs() {
            let docBreadcrumbs = [{ title: this.$t("common.loading") }];
        ...
        documentMenuItems() {
            return [
                ...
                },
                {
                    icon: TrashIcon,
                    key: "delete",
                    label: this.$t("document.deleteDocument"),
        ...
        partsHeaders() {
            return [
                { label: this.$t("document.name"), value: "title", image: "thumbnail" },
                {
                    label: this.$t("document.lastUpdate"),
                    value: "updated_at",
            ...
            let actions = [
                {
                    ...
                    icon: ToolsIcon,
                    key: "tasks",
                    label: this.$t("document.quickActions"),
                ...
                },
                {
                    ...
                    icon: ModelsIcon,
                    key: "models",
                    label: this.$t("document.documentModels"),
                    panel: ModelsPanel,
                }
            ];
